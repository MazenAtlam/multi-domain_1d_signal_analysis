...
const Doppler = () => {
  ...
  const handleDopplerAnalysis = async (fileToDetect) => {
    ...
    const response = await fetch(API_BASE_URL + "api/doppler/analysis", {
      method: "POST",
      body: formData,
    });
  ...
  const handleChooseFile = async (e) => {
    ...
    try {
      ...
      console.log(
        `Doppler detection results: {frequency: ${frequency}, velocity: ${velocity}}`
      );
  ...
  const handleLoadSomeData = async () => {
    ...
    // Update the index
    setAudioFileIndex(
      audioFileIndex >= audioFilesNumber - 1 ? 0 : audioFileIndex + 1
    );
    ...
    // Analyze doppler parameters: frequency and velocity
    try {
      const loaded = await fileFromAudioRef(
        audioRef,
        fileUrl,
        fileNameFromIndex
      );
      ...
      console.log(
        `Doppler detection results: {frequency: ${frequency_2}, velocity: ${velocity_2}}`
      );
      setMessage("Analysis completed successfully.");
    } catch (error) {
      console.error("Error uploading signal:", error);
  ...
  const handleGenerateSignal = async () => {
    ...
    if (
      ...
      setMessage(
        "- Frequency must be in range 100-800 Hz\n" +
    ...
    try {
      ...
      // Make the API request
      const response = await fetch(API_BASE_URL + "api/doppler/generate", {
        method: "POST",
        headers: {
              ...
              <div className="flex items-center space-x-3 justify-between">
                ...
                <div className="ms-3">
                  ...
                  <p className="text-muted-foreground">
                    Frequency & Velocity Signal Processing
                  </p>
                </div>
              </div>
            </div>
            ...
            <Card className="d-flex align-items-center">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground text-sm">
                  Simulate Doppler shift using custom velocity and frequency
                  parameters
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <div className="text-center space-y-3">
                    ...
                    <div className="text-3xl font-bold text-signal-doppler">
                      {velocity || "0"}
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Calculated velocity
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="ms-3">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>
                    • For generation: Enter source frequency (100-800 Hz) and
                    velocity (5 to 60 m/s)
                  </li>
                  <li>
                    • For analysis: Upload clear audio with minimal background
                    noise
                  </li>
